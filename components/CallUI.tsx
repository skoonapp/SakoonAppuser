...
const fetchZegoToken = async (roomId: string, userId: string, userName: string): Promise<string> => {
    ...
    // Example backend endpoint (you need to create this, e.g., using a Firebase Cloud Function)
